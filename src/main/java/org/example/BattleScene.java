...
public class BattleScene extends JFrame {
    ...
    private final boolean SHOW_HP_TEXT = false;
    ...
    private void setupHpBars() {
        ...
        playerHpText = new JLabel("", SwingConstants.LEFT);
        playerHpText.setBounds(
                PLAYER_HP_X + 15,
                PLAYER_HP_Y + PLAYER_HP_HEIGHT - 10,
                PLAYER_HP_WIDTH,
                25
        );
    ...
    private void refreshEnemyHpBarSkin() {
        ...
        if (enemyIndex == enemies.size() - 1) {
            ...
            enemyHpText.setBounds(BOSS_HP_X, BOSS_HP_Y + BOSS_HP_HEIGHT - 10, BOSS_HP_WIDTH, 25);
        } else {
            enemyHpBar = new ImageHpBar(
                    HP_KROCO_FILL_PATH,
                    HP_KROCO_FRAME_PATH,
            ...
            enemyHpText.setBounds(KROCO_HP_X, KROCO_HP_Y + KROCO_HP_HEIGHT - 10, KROCO_HP_WIDTH, 25);
        }
    ...
    private String getArmorFolder() {
        ...
        if (tipeArmor.equalsIgnoreCase("Almet")) {
            return "almamater";
