...
public class KerisApi extends Weapon {
    public KerisApi(String namaItem, Elemen elemen, int hargaBP, int baseDamage) {
        super(namaItem, elemen, hargaBP, baseDamage);
    }

    @Override
    public String getBasicAttackName() {
        return "Tusukan Keris";
    }
    ...
    public Item cloneItem() {
        return new KerisApi(getNamaItem(), getElemen(), getHargaBP(), getBaseDamage());
    }
}